...
class SceneEvents_0 extends SceneScript
{
	...
	override public function init()
	{
		...
		playSoundOnChannel(getSound(50), Std.int(1));
		...
		addWhenTypeGroupKilledListener(getActorType(2), function(eventActor:Actor, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				switchScene(GameModel.get().scenes.get(0).getID(), createFadeOut(2, Utils.getColorRGB(153,0,153)), createFadeIn(2, Utils.getColorRGB(0,0,0)));
			}
		});
